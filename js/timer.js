    ...
    Vue.component('loading-bar', {
      template: `
          <div>
              ...
              <div class="progress" v-show="now >= 1505984353">
                  <div class="progress-bar" role="progressbar" v-bind:aria-valuenow="percent" aria-valuemin="0" aria-valuemax="100" v-bind:style="{ width: percent + '%' }" v-show="now >= 1505984353">
                      <span class="sr-only">60% Complete</span>
                  </div>
                  <div class="milestone-soft" v-show="now >= 1505984353"></div>
              </div>
              <div class="progress-facts" v-show="now >= 1505984353">
